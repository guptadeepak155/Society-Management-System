...
<div class="page">
       <div class="navbar">
           ...
           <h1>paraiso<span style="font-family: 'Merienda', cursive;
            color:rgb(216, 20, 216);">HUB</span></h1>
           <nav>
               <ul>
    ...
    <footer>
        <div class="main-content">
            <div class="left box">
                ...
                <div class="content">
                    <p>
                        <li>ParaisoHUB is webapp where society members can get all the updates related to their society.</li>
                        <li>Members also get notified with notices and events held in society and can see information about members in society.</li>
                        <li>Members can also post complaints regarding any issue in society.</li>
                    </p>
                </div>
            </div>
            ...
            <div class="right box">
                ...
                <div class="place">
                        ...
                        <span class="text">Mumbra,Thane</span>
                    </div>
                    <div class="phone">
                        <span class="fas fa-phone-alt"></span>
                        <span class="text">8652495308</span>
                    </div>
                    <div class="email">
                        <span class="fas fa-envelope"></span>
                        <span class="text">paraisoHUB@gmail.com</span>
                    </div>
                </div>
            </div>
        </div>
