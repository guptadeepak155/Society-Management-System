...
<input type="checkbox" id="check">
    ...
    <div class="content"> 
      ...
      $sql = "SELECT Enteryourname,Flatno FROM registration where Enteryourname='$user_name'";
      ...
      echo '<div class="col-div-3">
        <div class="box">
          <p>'.$row['Enteryourname'].'<br><span>Your Name</span></p>
     ...
     <br><span>Your Flat No.</span></p>
      ...
      <div class="col-div-3">
        <div class="box">
          <p>Anil Mundetiya<br><span>Society Secretary</span></p>
