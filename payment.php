                ...
                <div class= "paycontainer">
                    ...
                    <form action="#" method="POST">
                        <div class="payform">
                            ...
                            <input type="date" class="field" name="pdateofpayment" placeholder="Enter the date"  required><br>
...
if(isset($_POST['ppaymnet'])){
    ...
    $query = "insert into payrecords values(null,'$_POST[ptitle]','$_POST[pflat]','$_POST[pamount]','Paid')";
